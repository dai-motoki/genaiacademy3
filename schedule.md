...
| --- | --- | --- |
| 5/18(土) | A.1 生成AI概論 | A.2 生成AIエディタ講習（IT教育3年 あきらパパさん） |
| 5/19(日) | C.1.1 生成AI開発概論講習（gimuさん） | - |
| 5/25(土) | C.2.1 生成AI基礎開発講習 | - |
| 5/26(日) | C.1.2 テキスト生成AI開発講習 | C.2.4 ワークフロー講座 |
| 6/1(土) | B.1 ビジネスフレームワーク&AIツール実践講習 | C.2.2 フロントエンド開発講座 |
| 6/2(日) | B.2 生成AI営業・マーケティング講座（藤田さん、layerX あやみさん） | C.2.3 バックエンド開発講座（坂本さん） |
| 6/8(土) | C.3.1 クラウド・生成AI講習①: 基礎: 一般クラウド&AI| A.3 生成AIの倫理とガバナンス、ビジネスとキャリア（吉野さん、 gimuさん、篠田さん） |
| 6/9(日) | C.3.2 クラウド・生成AI講習②: 応用 （坂本さん、篠田さん）| C.2.4 ワークフロー講座 （元木 Zoltraak, まるさん Dify） |
| 6/15(土) | B.3 生成AIUIUX&コンサル講座（永松健志さん (株式会社ニジボックス)、ビヨンドさん（BCG出身）: 新規事業立ち上げとは | B.3 BTC大乱闘 |
| 6/16(日) | - | - |

- 「C.2.4 ワークフロー講座」は人気の講座のため2回に分けています。基本的には同一内容でお送りする予定ですが、少々日程に時間が空きますので、
内容にブラッシュアップがございます。ご登録の際はどちらの内容も動画として配布いたしますので、どちらかの日程を押さえていただけますと幸いです。


### 開催場所  
- オンライン、オフラインOK（場合によって人数を調整いたします）
- オフラインは東京都内麹町（詳細は購入手続き後連絡いたします）
- 受講できない日はアーカイブ登録をご検討ください（1講座1万円引き）
...
| 大分類 | 条件 | 割引内容 |
| --- | --- | --- |
| 講師割引 | 過去講師・今回講師 | 3回分無料 |

| 大分類 | 条件 | 割引内容 |
| --- | --- | --- |
| 特別割引 | 3月までの講習を受けられた方 | 3割引 |
| 特別割引 | 4月までの講習を受けられた方 | 2割引 |
| 特別割引 | 学生の方 | 3割引（学生かつ過去受講生は6割引） |
| 特別割引 | 高校生（浪人生含む）以下の方で以前無料キャンペーンの元木のポストをリポスト頂いた方 | 全講座無料 |

| 大分類 | 条件 | 割引内容 |
| --- | --- | --- |
| 特別割引 | 今回の講座のXポストをプロンプトを参考にリポストいただける方 | 1割引 |


- アーカイブ動画での受講は1講座あたり1万円の割引となります（オンライン、オフライン推奨）

アーカイブは基本的に土日分を月曜日中を目安に配信させていただく予定でございます。
また、宿題も一緒にお送りさせていただきますが、より高いレベルの課題に取り組んでいただくほど、
将来的により多くの特典（クローズ講座、案件など）を得られる形となっております。


#### 注意事項:
- 基本的にキャンペーンにてリポストした方のみの参加となり、それ以外は上記学生割と同一です。
- 学生の方は身分証明書など写真を撮ってお送りください。案内を送ります。
